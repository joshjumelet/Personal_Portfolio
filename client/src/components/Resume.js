          ...
          <div className="resume-text">
            ...
            <div className="resume-body">
              <p>
                ...
                time. Eager to contribute a blend of technical expertise and
                sales acumen to drive value and success.
              </p>
            </div>
            <div className="resume-body">
              ...
              <ul>
                ...
                <li className="resume-list">
                  <p>
                    ...
                    fundamentals, algorithms, and data structures through
                    project development.
                  </p>
                </li>
              </ul>
              <h3>US Foods - Territory Manager | Sales</h3>
              <h5 className="date">12/2020 - 02/2023</h5>
              <ul>
                <li className="resume-list">
                  <p>
                ...
                <li className="resume-list">
                  <p>
                    ...
                    while managing priorities to ensure sound decision making in
                    a high pressure environment.
                  </p>
                </li>
                <li className="resume-list">
                  <p>
                    Efficiently solve client facing and back-end complications
                    and proactively determine potential issues to identify the
                    most effective strategies to resolve each problem.
                  </p>
                </li>
              </ul>
              <h3>ServPro of Seattle NW - Marketing | Account Manager</h3>
              <h5 className="date">01/2020 - 06/2020</h5>
              <ul>
                <li className="resume-list">
                  <p>
                    Developed daily, weekly, and annual strategic plans to
                    increase engagement and adoption of company growth driving
                    programs that included meetings and training with key
                    decision makers.
                  </p>
                </li>
                <li className="resume-list">
              ...
              <h5 className="date">05/2016 - 01/2020</h5>
              <ul>
                <li className="resume-list">
                  <p>
                    Growth driven role that emphasized targeting new and
                    established accounts to increase overall penetration of
                    goods and services to meet quarterly sales requirements and
                    goals.
                  </p>
                </li>
                <li className="resume-list">
                  <p>
                    ...
                    analyzing complex data and identifying key insights
                    regarding business analytics to assist in determining
                    effective selling strategies.
                  </p>
                </li>
                <li className="resume-list">
                  <p>
                    Emphasis on collaboration with team members to achieve
                    client and internal facing project goals and deliverables.
                  </p>
                </li>
              </ul>
              <h3>United States Army - Sergeant E-5</h3>
              <h5 className="date">10/2010 - 10/2018</h5>
              <ul>
                <li className="resume-list">
                  <p>
